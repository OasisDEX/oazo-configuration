...
export const getNavigation = () => ({
  protocols: {
    ajna: {
      borrow: {
        description:
          "Borrow against ETH, WBTC, DAI and any other type of collateral with AJNA.",
      },
      multiply: {
        description:
          "Increase exposure to ETH, WBTC and more with AJNA; access top risk management tools.",
      },
      earn: {
        description:
          "Earn yield on ETH, WBTC, DAI and more with AJNA; and get exclusive token rewards.",
      },
      extra: {
    ...
    morphoBlue: {
      borrow: {
        description:
          "Borrow against multiple collaterals in a new decentralized protocol",
      },
      multiply: {
        description:
          "Multiply exposure to WSTETH and other assets with high LTV",
      },
      earn: {
        description:
          "Deposit to the most trusted MetaMorpho Vaults to earn a yield",
      },
      extra: {
        title: "WSTETH/USDC Borrow",
        description: "Gain the most extra capital against your yielding ETH",
    ...
    spark: {
      ...
      multiply: {
        description:
          "Increase exposure to ETH and LSTs; access top risk management tools.",
      },
      earn: {
        description:
          "Earn yield on ETH and DAI. Become eligible for token rewards.",
      },
      extra: {
        title: "Amplify stETH up to 9.99x.",
        description:

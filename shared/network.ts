...
export enum Network {
    ...
    POLYGON = 'polygon',           // Polygon (previously Matic) Mainnet

    // Testnets
    GOERLI = 'goerli',             // Ethereum Goerli Testnet
    OPTIMISM_GOERLI = 'optimism_goerli',    // Optimism Layer 2 on Goerli Testnet
    ARBITRUM_GOERLI = 'arbitrum_goerli',    // Arbitrum Layer 2 on Goerli Testnet
